...
const styles = StyleSheet.create({
  ...
  form_unique:       { marginBottom: spacing.sm },
  gap_unique:        { marginTop: spacing.md },
  ...
  midTagline_unique: {
    ...
    alignItems:     'center',
    justifyContent: 'center',
    minHeight:      insets.avatarLg + insets.avatarSm - spacing.sm,
  },
  midTitle_unique: { fontSize: 15, fontWeight: '700', marginBottom: spacing.xs },
  ...
  footerGap_unique: { marginTop: spacing.md },
